...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://smartmessenger.pro.provider.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("smartmessenger.pro.provider.mms", "mms/#", SINGLE_ROW);
  }
